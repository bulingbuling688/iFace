...
function CustomBuilder({ onGenerate }: { onGenerate: (prompt: string) => void }) {
...
## 下一道题...`}
      ...
      >
        ...
        >
          ...
          <span>
            • <strong>模块</strong> 字段自动映射（js/react/css/ts/网络/性能/手写/项目）
          </span>
          <span>
            • <strong>难度</strong> 支持：初级/中级/高级
          </span>
          <span>
            • <strong>标签</strong> 用逗号或顿号分隔
          </span>
          <span>
            • <strong>来源</strong> 可选，如"高频"、"字节"
          </span>
...
export default function PromptPage() {
  ...
  return (
    <div className="page-container animate-fade-in" style={{ maxWidth: 1100 }}>
          ...
          {rightTab === 'converter' ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              {displayPrompt && (
                ...
                >
                  <p style={{ fontSize: 12, fontWeight: 600, color: 'var(--text)' }}>使用步骤</p>
      ...
      {/* ── Tips ── */}
      <div className="animate-fade-in stagger-3" style={{ marginTop: 32 }}>
        <p
          style={{
            fontSize: 11,
            fontWeight: 600,
      ...
      {/* ── Recommended scale ── */}
      <div className="animate-fade-in stagger-4" style={{ marginTop: 20 }}>
        <div className="card" style={{ padding: 20 }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={target} style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                    <td
                      style={{
          ...
          >
            推荐从「覆盖全面」开始，500-600 题已足够覆盖 95% 的前端面试考点。超过 800
